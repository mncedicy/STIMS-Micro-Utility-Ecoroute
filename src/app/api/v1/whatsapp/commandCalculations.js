...
export async function executeEmissionsCalculations({ lowerMessage, userProfile, tokenRecord, currentUsage, usageCap, businessPhoneNumberId, cleanPhoneNumber, supabaseAdmin, incomingServerUrl }) {
    ...
    try {
        ...
        // FIXED: Updated prefix verification rules to use hyphens to prevent callback token collisions with text macros
        const isInteractiveCallbackId = lowerMessage.startsWith('gas-type-') || lowerMessage.startsWith('gas-unit-');
