    ...
    return (
        <div className="space-y-2 font-mono text-xs border-t border-slate-900 pt-4">
            ...
            <div className="space-y-2 mt-2 pl-2 border-l border-slate-800 text-slate-400">
                <p>
                    <strong className="text-slate-100 font-bold">6.1 Payout Limit Caps:</strong> Commissions only apply to the initial subscription payment count limit configured for each application layout in our database rules. Payout cycles stop generating once this threshold limit is reached.
                </p>
                <p>
                    <strong className="text-slate-100 font-bold">6.2 One-Time Credit Rule:</strong> Referral pathways are credited on a one-time basis per referred account entity. If a referred friend cancels their plan and resubscribes again later, no duplicate commissions or extra tracking credits will be assigned to your ledger balance.
                </p>
                ...
                <p>
                    <strong className="text-slate-100 font-bold">6.7 Minimum Withdrawal Threshold:</strong> Payout requests are subject to a minimum cashout limit constraint of R100.00 ZAR. Balance values below this number cannot be extracted.
                </p>
            </div>
        </div>
    );
